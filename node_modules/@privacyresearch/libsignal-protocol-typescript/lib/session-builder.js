...
class SessionBuilder {
    constructor(storage, remoteAddress) {
        ...
        this.startSessionAsInitiator = (EKa, IKb, SPKb, OPKb, registrationId) => __awaiter(this, void 0, void 0, function* () {
            ...
            const masterKey = yield Internal.HKDF(helpers_1.uint8ArrayToArrayBuffer(sharedSecret), new ArrayBuffer(32), 'WhisperText');
            const session = {
    ...
    processV3(record, message) {
        return __awaiter(this, void 0, void 0, function* () {
            const trusted = this.storage.isTrustedIdentity(this.remoteAddress.name, helpers_1.uint8ArrayToArrayBuffer(message.identityKey), types_1.Direction.RECEIVING);
            if (!trusted) {
                throw new Error(`Unknown identity key: ${helpers_1.uint8ArrayToArrayBuffer(message.identityKey)}`);
            }
            ...
            yield this.storage.saveIdentity(this.remoteAddress.toString(), helpers_1.uint8ArrayToArrayBuffer(message.identityKey));
