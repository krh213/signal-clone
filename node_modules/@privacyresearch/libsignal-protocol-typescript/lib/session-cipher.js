...
class SessionCipher {
    ...
    decryptPreKeyWhisperMessage(buff, encoding) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const job = () => __awaiter(this, void 0, void 0, function* () {
                ...
                const session = record.getSessionByBaseKey(helpers_1.uint8ArrayToArrayBuffer(preKeyProto.baseKey));
                if (!session) {
    ...
    doDecryptWhisperMessage(messageBytes, session) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const remoteEphemeralKey = helpers_1.uint8ArrayToArrayBuffer(message.ephemeralKey);
            ...
            const plaintext = yield Internal.crypto.decrypt(keys[0], helpers_1.uint8ArrayToArrayBuffer(message.ciphertext), keys[2].slice(0, 16));
